...
<br/>
<div>
<c:forEach items="${sessionScope.aoiposts}" var="aoiposts">
	<div class="post-container">
		<c:out value="${aoiposts.nameofuser}"/><br/></br>
		Area of Interest: <c:out  value="${aoiposts.aoi}"/><br/><br/>
		Article Url: <c:out  value="${aoiposts.url}"/><br/><br/>
		Description: <c:out  value="${aoiposts.description}"/><br/>
	</div>
