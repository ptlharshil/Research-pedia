...
<div class="msg-form">
<c:forEach items="${sessionScope.prof}" var="prof">
	
		Name: <c:out value="${prof.name}"/><br/></br>
		Email: <c:out value="${prof.email}"/><br/><br/>
		Occupation: <c:out value="${prof.occupation}"/><br/><br/>
		Institution: <c:out value="${prof.institution}"/><br/><br/>
		Area of Interest: <c:out value="${prof.areaofinterest}"/><br/><br/>
		Articles:<br/> <c:forEach items="${prof.articles}" var="article">
		${article}<br/><br/>
				  </c:forEach>
